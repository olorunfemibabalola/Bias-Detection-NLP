{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMWmH84glz/Wqv7/cgKfKmU",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/olorunfemibabalola/Bias-Detection-NLP/blob/main/README.txt\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
      "source": [
        ...
        "* **Real-Time Monitoring:** The chatbot must detect and flag biased user inputs (e.g., \"hire young people\") immediately during conversation.\n",
        ...
        "* **Design Choice:** I selected Qwen 2.5 over other models because:\n",
        "    * **Context Window:** It supports 128k tokens natively, allowing for the auditing of entire employee handbooks (50+ pages) without the fragmentation issues observed in some other models.\n",
        "    * **Instruction Following:** In preliminary tests, Qwen demonstrated superior adherence to strict \"System Roles,\" whereas other models occasionally refused to audit neutral text due to overly aggressive safety filters (\"Refusal Rejection\").\n",
