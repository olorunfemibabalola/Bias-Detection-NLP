{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOztdaWTQxK1LqA1yfltzf0",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/olorunfemibabalola/Bias-Detection-NLP/blob/main/README.md\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
      "source": [
        "# README:\n",
        "\n",
        "**Project Title:** Inclusive HR Policy Assistant & Bias Auditor  \n",
        ...
        "The objective was to develop a domain-specific AI application capable of mitigating \"Representational Harms\" in Human Resources (HR) documentation.\n",
        "\n",
        ...
        "> **Prompt:** \"You are a Senior HR Compliance Officer. Your job is to audit corporate policies for social bias. STRICT RULES: Analyze the text for Gender, Race, and Ageism. Do NOT summarize. List specific problematic sentences, assign a SEVERITY SCORE (1-10), and provide a NEUTRAL REWRITE.\"\n",
        "\n",
        ...
        "\n",
        "1.  **Open the Notebook:** Upload `NLP576757_Code_StudentID.ipynb` to Google Colab.\n",
